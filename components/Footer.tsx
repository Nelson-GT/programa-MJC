...
const Footer = () => (
    <footer className="pt-50 px-20 sm:pt-44">
            ...
            <div className="flex flex-wrap gap-y-10 items-center justify-between">
                <div className="space-y-4">
                    ...
                    <div className="pt-2 flex items-center gap-x-6 text-gray-400">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=584143410642" target="_blank" aria-label="Social media">
                        ...
                        <a href="https://www.instagram.com/sinfocarabobo" target="_blank" aria-label="Social media">
