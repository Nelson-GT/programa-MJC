    ...
    try {
        const query = `
            SELECT 
                ...
                e.profesion_representante,
                e.lugar_trabajo_representante,
                e.direccion_representante,
                e.email_representante,
                e.nombre_emergencia,
                e.numero_emergencia,
                e.instrumento,
                e.teoricas,
